...
PROFILES: list[Profile] = [
    Profile(
        ...
        travel_mode="solo", age_range="70+", children=False,
    ...
    Profile(
        ...
        travel_mode="couple", age_range="26-35", children=False,
        vector={"nature": 0.3, "culture": 0.6, "food": 0.9, "adventure": 0.2,
                "nightlife": 0.3, "relax": 0.7, "family_friendly": 0.0},
        description=(
            "Una coppia sui 30 anni in fuga romantica: la priorità è mangiare benissimo e "
    ...
    Profile(
        ...
        travel_mode="solo", age_range="18-25", children=False,
    ...
    Profile(
        ...
        travel_mode="friends", age_range="18-25", children=False,
    ...
    Profile(
        ...
        travel_mode="family", age_range="36-45", children=True,
    ...
    Profile(
        ...
        travel_mode="couple", age_range="46-55", children=False,
    ...
    Profile(
        ...
        travel_mode="solo", age_range="26-35", children=False,
    ...
    Profile(
        ...
        description=(
            "Una coppia sui 30 anni, turisti \"medi\": vogliono un po' di tutto in modo "
